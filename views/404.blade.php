...
<main class="min-h-screen bg-top bg-cover sm:bg-top" style="background-image: url('https://cdn.pixabay.com/photo/2018/07/07/11/30/success-3521937_960_720.jpg');">
  <div class="px-4 py-16 mx-auto text-center max-w-7xl sm:px-6 sm:py-24 lg:px-8 lg:py-48">
    ...
    <div class="mt-6">
      <a href="/" class="inline-flex items-center px-4 py-2 text-sm font-medium text-black text-opacity-75 duration-150 transform bg-white bg-opacity-75 border border-transparent rounded-md hover:scale-105 hover:shadow sm:bg-opacity-50 sm:hover:bg-opacity-75">
